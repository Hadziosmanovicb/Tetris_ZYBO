...
proc create_root_design { parentCell } {
  ...
  set ctrl_btns [ create_bd_port -dir I -from 4 -to 0 -type data ctrl_btns ]
  ...
  connect_bd_net -net btn_1 [get_bd_ports btn] [get_bd_pins xlconcat_1/In0]
  connect_bd_net -net ctrl_btns_1 [get_bd_ports ctrl_btns] [get_bd_pins xlconcat_1/In1]
  ...
  connect_bd_net -net xlconcat_1_dout [get_bd_pins axi_gpio_btn/gpio_io_i] [get_bd_pins xlconcat_1/dout]
