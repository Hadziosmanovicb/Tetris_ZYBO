...
void DrawLevel(u8 *frame, u32 xStart, u32 yStart, u32 stride, char letter, u8 red, u8 green, u8 blue) {
    u32 blockSize = 5;
...
void ShowStartScreen(u32 stride, int *currentLevel) {
    ...
    u32 startY = dispCtrl.vMode.height / 4 - letterHeightTetris / 2;
    ...
    // Draw "LEVEL"
    DrawLevel(dispCtrl.framePtr[dispCtrl.curFrame], levelX, levelY, dispCtrl.stride, 'L', 255, 255, 255);
    DrawLevel(dispCtrl.framePtr[dispCtrl.curFrame], levelX + letterWidthLevel + spacingLevel, levelY, dispCtrl.stride, 'E', 255, 255, 255);
    DrawLevel(dispCtrl.framePtr[dispCtrl.curFrame], levelX + 2 * (letterWidthLevel + spacingLevel), levelY, dispCtrl.stride, 'V', 255, 255, 255);
    DrawLevel(dispCtrl.framePtr[dispCtrl.curFrame], levelX + 3 * (letterWidthLevel + spacingLevel), levelY, dispCtrl.stride, 'E', 255, 255, 255);
    DrawLevel(dispCtrl.framePtr[dispCtrl.curFrame], levelX + 4 * (letterWidthLevel + spacingLevel), levelY, dispCtrl.stride, 'L', 255, 255, 255);
...
void ShowGameOverScreen() {
	  ...
	  u32 gameOverStartX = (dispCtrl.vMode.width - (6 * gameOverLetterWidth + 7 * gameOverSpacing)) / 2 - 50;
	  u32 gameOverStartY = dispCtrl.vMode.height / 2 - gameOverLetterHeight / 2;
